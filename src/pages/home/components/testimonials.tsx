...
const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  return (
    <div
      className="bg-gradient-to-b from-[#1D1D1D] to-[#303030] text-white border-l-4 border-[#DED08A] rounded-md flex flex-col w-full p-6 flex-shrink-0"
      style={{
        boxShadow: "inset 0 2px 8px 3px #00000040, inset 0 0 10px #FFFFFF40",
      }}
    >
      <p className="text-[24px] font-normal font-sans">
        {" "}
        {/* Using font-sans, assuming Lato/Inter are handled by global CSS/Tailwind config */}
        {text}
      </p>
      <div className="flex items-center gap-4 my-4">
        <img
