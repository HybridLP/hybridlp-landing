...
export default () => {
  return (
    ...
    >
      ...
      <AnimatedSection>
        <p className="text-sm md:text-lg lg:text-[20px] text-center text-white w-full md:w-[80%] lg:w-[70%] mx-auto leading-relaxed md:leading-[28px] lg:leading-[32px] lato-regular font-normal mb-8 md:mb-12 lg:mb-16">
