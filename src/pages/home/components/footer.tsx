...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-black text-white ">
      {/* Main footer content */}
      <div className="mx-auto px-30 py-16 flex items-start justify-between">
          {/* Logo and tagline */}
          <div className=" w-[30%] d:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <img src={logo} className="w-[10rem]" alt="" />
            </div>
            <h2 className=" font-semibold text-[32px] inter-font">
          ...
          <div className=" lg:w-[15%]">
            <h3 className="text-[16px] font-medium mb-4 inter-font">
              About Hybrid LP
            </h3>
          ...
          {/* Features */}
          <div>
            <h3 className="text-lg font-medium mb-4 inter-font lato-regular">
              Features
            </h3>
          ...
          <div className="space-y-8 lg:w-[12%]">
            <div>
              <h3 className="text-lg font-medium mb-4 inter-font">
                Contact Us
              </h3>
              <p className="text-gray-300 text-sm lato-regular">
          ...
          <div className="flex  md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-6 text-sm text-gray-300">
                <a
                  href="#"
                  className="text-white lato-regular"
                >
                  Privacy Policy
                </a>
