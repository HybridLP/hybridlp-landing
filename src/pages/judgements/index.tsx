...
export default () => {
  ...
  const judgementsSchema = {
    "@context": "https://schema.org",
    "@type": "LegalService",
    name: "HybridLP Case Judgements",
    description:
      "Database of legal judgements and cases handled by Hybrid Law Practice.",
  ...
  return (
    <>
      <SEO
        title="Handled Cases & Judgements"
        description="Browse through the detailed judgements and legal outcomes of cases handled by Hybrid Law Practice."
        canonical="https://hybridlp.com/judgements"
        structuredData={judgementsSchema}
      />
